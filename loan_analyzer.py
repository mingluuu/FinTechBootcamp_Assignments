...
# YOUR CODE HERE!
num_loan = len(loan_costs)
print("The total number of loan is: " + str(num_loan))
...
print("The total value of the loan is: " + str(total_loan))

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
# YOUR CODE HERE!
average_loan = total_loan / num_loan
print("The average loan amount is: " + str(average_loan))
...
print("The remaininng months is: " + str(remaining_months))
...
# YOUR CODE HERE!
for l in loans:
    l_price = l.get("loan_price")
    if l_price <= 500:
        inexpensive_loans.append(l)
...
with open(output_path, 'w') as csvfile:
    ...
    for ll in inexpensive_loans:
        csvwriter.writerow(ll.values())